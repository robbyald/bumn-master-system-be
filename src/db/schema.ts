...
export const userPackage = sqliteTable(
  "user_package",
  {
    userId: text("user_id")
      .notNull()
...
export const userPointHistory = sqliteTable(
  "user_point_history",
  {
    id: text("id").primaryKey(),
    userId: text("user_id")
...
export const examPackage = sqliteTable(
  "exam_package",
  {
    id: text("id").primaryKey(),
...
export const questionUsage = sqliteTable(
  "question_usage",
  {
    id: text("id").primaryKey(),
...
export const latsolSet = sqliteTable(
  "latsol_set",
  {
    id: text("id").primaryKey(),
...
export const latsolSetQuestion = sqliteTable(
  "latsol_set_question",
  {
    id: text("id").primaryKey(),
...
export const latsolProgress = sqliteTable(
  "latsol_progress",
  {
    id: text("id").primaryKey(),
...
export const packageFeature = sqliteTable(
  "package_feature",
  {
    id: text("id").primaryKey(),
    packageId: text("package_id").notNull(),
...
export const paymentOrder = sqliteTable(
  "payment_order",
  {
    id: text("id").primaryKey(),
    userId: text("user_id").notNull(),
