...
const inputPath = resolve("data/goldset/akhlak-kompeten.json");
const outputPath = resolve("data/finetune/akhlak-kompeten-train.jsonl");

const raw = readFileSync(inputPath, "utf-8");
const items = JSON.parse(raw) as GoldQuestion[];

const system = [
  "Anda adalah pembuat soal AKHLAK submateri Kompeten.",
  "Gunakan 4 opsi jawaban (A–D).",
  "Semua soal berbasis skenario dunia kerja profesional (SJT).",
  "Fokus pada indikator: meningkatkan kompetensi diri, membantu orang lain belajar, dan kualitas terbaik.",
