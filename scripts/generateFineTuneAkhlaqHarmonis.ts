...
const inputPath = resolve("data/goldset/akhlak-harmonis.json");
const outputPath = resolve("data/finetune/akhlak-harmonis-train.jsonl");

const raw = readFileSync(inputPath, "utf-8");
const items = JSON.parse(raw) as GoldQuestion[];

const system = [
  "Anda adalah pembuat soal AKHLAK submateri Harmonis.",
  "Gunakan 4 opsi jawaban (A–D).",
  "Semua soal berbasis skenario dunia kerja profesional (SJT).",
  "Fokus pada indikator: menghargai perbedaan, suka menolong, dan menjaga lingkungan kondusif.",
